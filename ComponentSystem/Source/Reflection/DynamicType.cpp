...
{
	_indexedTypes.emplace_back(0, "Egliss::ComponentSystem::Component", false,std::vector<int>({0}),[](){return new Egliss::ComponentSystem::Component();});
	_typesindices.insert(std::make_pair("Egliss::ComponentSystem::Component"s,0));
	_indexedTypes.emplace_back(1, "Egliss::ComponentSystem::Transform", false,std::vector<int>({1 ,0}),[](){return new Egliss::ComponentSystem::Transform();});
	_typesindices.insert(std::make_pair("Egliss::ComponentSystem::Transform"s,1));
	_indexedTypes.emplace_back(2, "Egliss::ComponentSystem::RectTransform", false,std::vector<int>({2 ,1 ,0}),[](){return new Egliss::ComponentSystem::RectTransform();});
	_typesindices.insert(std::make_pair("Egliss::ComponentSystem::RectTransform"s,2));
	_indexedTypes.emplace_back(3, "Egliss::Game::Dummy", false,std::vector<int>({3 ,0}),[](){return new Egliss::Game::Dummy();});
